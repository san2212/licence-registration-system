...
<?php
  if(isset($_POST['search']))
  {
    ...
    $query=mysql_query("SELECT * FROM form WHERE fn LIKE '%$searchq%' OR ln LIKE '%$searchq%' OR adhaar LIKE '%$searchq%' OR mobile LIKE '%$searchq%'") or die("could not search");
...
mysql_select_db('form') or die('could not connect');
$res=mysql_query("SELECT * FROM form WHERE fn LIKE '%$searchq%' OR ln LIKE '%$searchq%' OR adhaar LIKE '%$searchq%' OR mobile LIKE '%$searchq%'") or die("could not search");
